// HexaCall – Dark Cinematic Voice AI Agency Website
// Stack: React + Tailwind CSS (Next.js compatible)
// Design goals: calm confidence, cinematic pacing, zero fluff, revenue-focused

import { motion } from "framer-motion";
import { useState } from "react";

export default function HexaCallWebsite() {
  ...
  const handleSubmit = async (e) => {
    ...
    setLoading(true);
    try {
      await fetch("https://hook.eu1.make.com/dewtu7211bqpe8uvqm6vkmigxpwbp159", {
        method: "POST",
  ...
  return (
    <div className="bg-[#0B0F14] text-gray-200 font-sans overflow-x-hidden">
      {/* ================= HERO ================= */}
      <section className="min-h-screen flex items-center justify-center relative px-6">
        <div className="absolute inset-0 bg-gradient-to-b from-[#0B0F14] via-[#0E1622] to-[#0B0F14]" />
      ...
      <section className="py-32 px-6 bg-[#0E1622]">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-10">
            {[
              "AI Call Answering (After-Hours & Overflow)",
              "Appointment Booking",
              "Appointment Rescheduling & Cancellations",
              "Call Forwarding + Smart Routing",
              "SMS & Email Confirmations",
              "Missed Call Capture",
              "Weekend & After-Hours Lead Recovery",
            ].map((service, i) => (
              <motion.div
                key={i}
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-10">
            {[
              ...
              "No. It handles overflow and after-hours.",
              "Does it work with our scheduling?",
              "Yes. It fits into your existing workflow.",
              "Is this hard to set up?",
              "No. Your team doesn’t need to change anything.",
              "Who is this for?",
              "Businesses where every call equals revenue.",
            ].map((item, i) => (
              <div key={i}>
                {i % 2 === 0 ? (
